...
class PostBaseForm(forms.ModelForm):
    ...
    destination_name = forms.CharField(label='Enter a destination name', required=False)
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Preserve user-entered data in 'book_title' and 'destination_name' after validation error
        if self.data:
